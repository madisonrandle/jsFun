...
const context = {
  exerciseA() {
    ...
    // ship.fly() refers to the class property this.fly
    // with a value of fly, which invokes the globally scoped function fly
    // because fly is invoked globally, this will refer to the global window object
  },
  ...
  exerciseB() {
    ...
    // Annotation:
    // Write your annotation here as a comment
    // when we invoke fn(), because it is globally scoped
